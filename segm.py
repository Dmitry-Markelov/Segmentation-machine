...
if os.path.exists('assets/test.weights.h5'):
    print("Файл существует.")
else:
    print("Файл не существует.")

images = sorted(glob.glob('assets/images/*.png'))
masks = sorted(glob.glob('assets/masks/*.png'))
...
dataset = dataset.repeat(50) #увеличение данных в 50 раз
...
train_dataset = dataset.take(40).cache()
test_dataset = dataset.skip(40).take(10).cache()
...
frames = sorted(glob.glob('assets/images/*.png'))
